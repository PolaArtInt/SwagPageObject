...
class TestCart(BaseTest):
    ...
    def test_add_to_cart(self, driver, login, inv_page, cart_page):
    ...
    @allure.epic('cart module')
    @allure.feature('cart')
    @allure.title('remove items from cart')
    @pytest.mark.positive
    ...
    @allure.epic('cart module')
    @allure.feature('cart')
    @allure.title('add items to cart from item card')
    @pytest.mark.positive
    def test_add_item_from_item_card(self, driver, login, inv_page, cart_page, item_page):
    ...
    @allure.epic('cart module')
    @allure.feature('cart')
    @allure.title('remove items from cart from item card')
    @pytest.mark.positive
    def test_remove_item_from_item_card(self, driver, login, inv_page, cart_page, item_page):
        with allure.step('pick the item text and add the item to the cart'):
