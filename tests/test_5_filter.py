...
class TestFilter(BaseTest):
    ...
    def test_a_to_z_filter(self, driver, login, inv_page, filter_page):
    ...
    @pytest.mark.positive
    def test_z_to_a_filter(self, driver, login, inv_page, filter_page):
    ...
    @pytest.mark.positive
    def test_low_to_high_filter(self, driver, login, inv_page, filter_page):
    ...
    @pytest.mark.positive
    def test_high_to_low_filter(self, driver, login, inv_page, filter_page):
